...
Make sure your environment variables $ISUHPC and $MYISUHPC are set properly.
...
MYHPC = os.environ.get('MYHPC','** not set **')
print ("Environment variable MYHPC is %s"  % MYHPC)
